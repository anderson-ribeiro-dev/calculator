...
export default {
    ...
    methods: {
        clearMemory(){
            ...
            Object.assign(this.$data, this.$options.data()) //estado inicial do objeto
        },
        ...
        addDigit(n) {
            ...
            const clearDisplay = this.displayValue === "0"
                || this.clearDisplay
            const currentValue = clearDisplay ? "" : this.displayValue // valor atual
            const displayValue = currentValue + n //novo valor

            this.displayValue = displayValue //altera o estado do componente 
            ...
            //     this.values[i] = newValue //indice 1 novo valor
            // }
        }
    },
}
